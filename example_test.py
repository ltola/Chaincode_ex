...
"""An example functional test of ------ Luca Tola ------
...
-------------------------------------------------------------------
Compile Bitcoin Core (https://github.com/bitcoin/bitcoin).You can see
doc/build-*.md for instructions on building the various elements.
Run the unit and functional tests. Instructions on how to do that can be
 found here (https://github.com/bitcoin/bitcoin/blob/master/test/README.md).
Look at example_test.py in the functional test directory
and try getting node 1 to mine another block, send it to node 2, and
check that node 2 received it. In your submission, please include a link
to a gist or code snippet that you used to complete this step.
--------------------------------------------------------------------
...
class ExampleTest(BitcoinTestFramework):
    ...
    def custom_method(self):
        ...
        self.log.info("Running custom_method...node0 and node1 friends")
